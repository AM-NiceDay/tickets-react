    ...
    return (
      <div className="page-profile">
        ...
        <span className="user-data">
          <img src={'http://dummyimage.com/100x100/b58db5/fff&text=user-img'} alt="image" className="user-data__image" />
          <p className="user-data__username">Антон Позняк</p>
          <p className="user-data__phone">+375 29 123 45 67</p>
        </span>
            <div className="user-nav-block">
              <ul className="user-nav">
                <li className="user-nav__elem">
                  <a className="user-nav__elem-link" href="#">Билет</a>
                </li>
                <li className="user-nav__elem">
                  <a className="user-nav__elem-link" href="#">Отзыв</a>
                </li>
                <li className="user-nav__elem">
                  <a className="user-nav__elem-link" href="#">Новости</a>
                </li>
                <li className="user-nav__elem">
                  <a className="user-nav__elem-link" href="#">Настройки</a>
                </li>
              </ul>
